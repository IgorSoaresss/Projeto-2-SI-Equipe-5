"""
Django settings for projeto_TypeFlow project.
...
SECRET_KEY = 'django-insecure-f(@n2d__scnflf0u*1hgfm%7h&u2kbd&_ckhvio=8kq8trmwi@'
...
WSGI_APPLICATION = 'projeto_TypeFlow.wsgi.application'
