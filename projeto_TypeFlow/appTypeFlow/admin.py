...
class MBTIDescriptionAdmin(admin.ModelAdmin):
    list_display = ('type', 'subtype', 'letra1', 'letra2', 'letra3', 'letra4', 'descricaoGeral', 'classe', 'subclasse', 'salaDeAula', 'gruposDeProjetos','primary_color', 'background_color', 'sidebar_color')
    search_fields = ('type',)
